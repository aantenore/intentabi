...
| Probabilistic compiler overreach    | compiler only proposes an operation; trusted registry owns Intent IR/effect; unknown/conflicting/write proposals bypass      | a wrong in-catalogue read proposal can still pass until external and deployment evaluation catches it |
